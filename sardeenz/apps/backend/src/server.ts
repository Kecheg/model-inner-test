...
import { IdleSleepManager } from './services/idle-sleep-manager.js'
...
const idleSleepManager = new IdleSleepManager(logger, config.idleSleepScanIntervalMs)
...
await fastify.register(import('./routes/kv-admission.js'))
